...
let objJSON = JSON.stringify(obj1)  // JSON строка которую можно передавать на сервер
console.log(objJSON)
newObj2 = JSON.parse(objJSON)
console.log(newObj2.info === obj1.info) //false - это разные обьекты, глуб копир произведено

let newOb = JSON.parse(JSON.stringify(newObj2)) // происходит глубокое копирование

let keys = Object.keys(obj1)    // вернет массив ключей обьекта
console.log(keys)

let vel = Object.values(obj1)  // массив со занчениями каждого ключа обькта
console.log(vel)
